...
public class Payaso {
    ...
    public Payaso() {
        ...
        // --- PIERNAS ---
        Cilindro piernaIzq = new Cilindro(6, 0.15f, 0.6f);
        piernaIzq.setColorPart("all", new float[]{.4f, 0f, .6f, 1});
        piernaIzq.move(-0.2f, 0.45f, 2);
        partes.add(piernaIzq);

        Cilindro piernaDer = new Cilindro(6, 0.15f, 0.6f);
        piernaDer.setColorPart("all", new float[]{.4f, 0f, .6f, 1});
        piernaDer.move(0.2f, 0.45f, 2);
        partes.add(piernaDer);

        // --- CUERPO ---
        Cilindro cuerpo = new Cilindro(6, 0.4f, 0.95f);
        cuerpo.setColorPart("all", new float[]{0.4f, 0f, .6f, 1});
        cuerpo.move(0f, 0.975f, 2);
        partes.add(cuerpo);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            boton.move(0f, 0.75f + i * 0.15f, 1.65f);
            partes.add(boton);
        }

        // CORBATIN
        Cono ala1 = new Cono(0.15f, 0.1f, 4);
        ala1.setColorPart("all", new float[]{.9f, .4f, 0f, 1});
        ala1.move(-0.1f, 1.25f, 1.6f);
        partes.add(ala1);

        Cono ala2 = new Cono(0.15f, 0.1f, 4);
        ala2.setColorPart("all", new float[]{.9f, .4f, 0f, 1});
        ala2.move(0.1f, 1.25f, 1.6f);
        partes.add(ala2);

        Sphere centroCorbata = new Sphere(0.05f, 20, 20);
        centroCorbata.setColor(new float[]{.9f, .4f, 0f, 1});
        centroCorbata.move(0f, 1.25f, 1.6f);
        partes.add(centroCorbata);

        // --- CABEZA ---
        Cilindro cabeza = new Cilindro(12, 0.3f, 0.6f);
        cabeza.setColorPart("all", new float[]{.98f, 0.95f, 0.98f, 1});
        cabeza.move(0f, 1.6f, 2);
        partes.add(cabeza);

        // NARIZ
        Sphere nariz = new Sphere(0.09f, 20, 20);
        nariz.setColor(new float[]{1f, 0f, 0f, 1});
        nariz.move(0f, 1.6f, 1.7f);
        partes.add(nariz);

        // OJOS
        Sphere ojoIzq = new Sphere(0.06f, 20, 20);
        ojoIzq.setColor(new float[]{0.05f, 0.05f, 0.05f, 1});
        ojoIzq.move(-0.1f, 1.65f, 1.7f);
        partes.add(ojoIzq);

        Sphere ojoDer = new Sphere(0.06f, 20, 20);
        ojoDer.setColor(new float[]{0f, 0f, 0f, 1});
        ojoDer.move(0.1f, 1.65f, 1.7f);
        partes.add(ojoDer);

        // PELO
        Sphere orejaIzq = new Sphere(0.09f, 20, 20);
        orejaIzq.setColor(new float[]{0f, 0.6f, 0f, 1});
        orejaIzq.move(-0.35f, 1.6f, 2);
        partes.add(orejaIzq);

        Sphere orejaDer = new Sphere(0.09f, 20, 20);
        orejaDer.setColor(new float[]{0f, 0.6f, 0f, 1});
        orejaDer.move(0.35f, 1.6f, 2);
        partes.add(orejaDer);

        Sphere orejaIzq1 = new Sphere(0.09f, 20, 20);
        orejaIzq1.setColor(new float[]{0f, 0.6f, 0f, 1});
        orejaIzq1.move(-0.35f, 1.75f, 2);
        partes.add(orejaIzq1);

        Sphere orejaDer2 = new Sphere(0.09f, 20, 20);
        orejaDer2.setColor(new float[]{0f, 0.6f, 0f, 1});
        orejaDer2.move(0.35f, 1.75f, 2);
        partes.add(orejaDer2);

        // --- BRAZOS ---
        Cilindro brazoIzq = new Cilindro(6, 0.15f, 0.7f);
        brazoIzq.setColorPart("all", new float[]{0f, 0.4f, 0.3f, 1});
        brazoIzq.move(-0.6f, 1.2f, 2);
        brazoIzq.rotate(0, 0, -45);
        partes.add(brazoIzq);

        Cilindro brazoDer = new Cilindro(6, 0.15f, 0.7f);
        brazoDer.setColorPart("all", new float[]{0f, 0.4f, 0.3f, 1});
        brazoDer.move(0.6f, 1.2f, 2);
        brazoDer.rotate(0, 0, 45);
        partes.add(brazoDer);

        // MANOS
        Sphere manoIzq = new Sphere(0.15f, 20, 20);
        manoIzq.setColor(new float[]{1f, 0.8f, 0.6f, 1});
        manoIzq.move(-0.85f, 1.45f, 2);
        partes.add(manoIzq);

        Sphere manoDer = new Sphere(0.15f, 20, 20);
        manoDer.setColor(new float[]{1f, 0.8f, 0.6f, 1});
        manoDer.move(0.85f, 1.45f, 2);
        partes.add(manoDer);
